...
Laptop temperatures with this cooler always connected and working are (see PDF)...
...
Here I would pay attention what does EnergyEstimationEnabled option… I have turned it off, but that is my choice…
...
I have created for EfficiencyClass 1 with the same options and with same PowerEnvelope of Decimal values: 4700… But that setting how you want to set your PC is on you…
...
-	Type 4145
You will notice that those values have a DWORD named “Value” and that it is turned off, I haven’t tried turning it on…
...
-	Best option: Lightest Performance State
-	My setting implemented: Deepest Performance State
...
-	Setting implemented: Enable scaling
...
In registry keys implement Intel graphics settings (see PDF);
